...
async function obfuscate(userCode, settings) {
  ...
  // نحقن جدول preload يحوي كل المصادر، ونعرّف require يقرأ منه.
  // نبني سترنق لوا يسجّل package.preload لكل موديول.
  let bootstrap = "local __src = {}\n";
...
window.HerculesWeb = { obfuscate, loadSources };
